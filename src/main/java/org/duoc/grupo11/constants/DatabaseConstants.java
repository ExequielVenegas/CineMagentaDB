...
public class DatabaseConstants {
    ...
    public static final  String INSERT_SQL = "INSERT INTO Cartelera (titulo, director, anio, duracion, genero) VALUES (?, ?, ?, ?, ?)";
    ...
    public static final  String SELECT_WHERE_ID_SQL = "SELECT COUNT(*) FROM Cartelera WHERE id = ?";
